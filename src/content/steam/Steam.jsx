  ...
  return (
    <div className="authorization-container" onMouseMove={handleMouseMove} style={{ backgroundPosition }}>
      <div className="authorization-box">
        ...
        <p> Ура, вы являетесь участником нашего Discord сервера,
            Но ещё не прошли процесс регистрации.</p>
            <p>
            Чтобы продолжить, нам также необходима информация
            о вашем Steam аккаунте</p>
        <div className="icon">
          <img src="src/assets/Steam.svg" alt="" />
        </div>
      </div>
