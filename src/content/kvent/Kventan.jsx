  ...
  return (
    <div className="authorization-container" onMouseMove={handleMouseMove} style={{ backgroundPosition }}>
      <div className="authorization-box">
        ...
        <p>Мы получили вашу заявку. Как только мы примем решение о допуске васна сервер, вы получите уведомление от нашего Discord-бота.</p>
            <p>Если же ваша квента не будет одобрена, то вы получите инструкциио дальнейших действиях от бота.</p>
